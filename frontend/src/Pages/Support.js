    ...
    <div className="support-container">
      ...
      <div className="support-options">
        ...
        <div className="support-card">
          ...
          <h4>Call Us</h4>
          <a href="tel:+917538892222" className="support-link">+91 75388 92222</a>
        </div>
        ...
        <div className="support-card">
          ...
          <h4>Email</h4>
          <a href="mailto:support@yourstore.com" className="support-link">bharathdharmendiran2002@gmail.com.com</a>
        </div>
